...
| **LTX Chain: Auto Scenes** | Florence‑2 caption → full singing prompt; ethnicity/age/singers/performance/extra cameras/microphone/gender/emotion/motion/height/build/camera/outfit, plus **look / lighting / setting** presets composed with the free `style` text. / 画像→プロンプト自動生成（服装補足・画調/照明/舞台プリセット付き） |
